    ...
    <div className="grid gap-4">
      <div className="flex items-center justify-between px-2 sm:px-0">
        ...
        <Link
          ...
          className="inline-flex min-h-10 items-center text-sm font-semibold text-[color:var(--px-primary)] hover:text-[color:var(--px-primary-strong)] hover:underline"
        >
          See all
        </Link>
      </div>
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-4">
                  ...
                  <p className="mt-1 flex items-center gap-1 text-xs font-medium text-[color:var(--px-text-muted)]">
                    ...
                    <ShieldCheck
                      size={12}
                      className="text-[color:var(--px-gold)]"
                    />
                  </p>
