...
const variants = {
  ghost: "ptahx-btn-ghost border border-transparent",
  primary: "ptahx-btn-primary",
  secondary: "ptahx-btn-secondary",
  warm: "ptahx-btn-warm",
...
export function Button({ className, variant = "primary", size = "default", ...props }: ButtonProps) {
  return (
    <button
      className={cn(
        "inline-flex items-center justify-center rounded-[var(--px-radius-sm)] font-semibold transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--px-focus)] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
        variants[variant],
        sizes[size],
        className,
      )}
