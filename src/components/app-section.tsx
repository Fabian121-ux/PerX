  ...
  return (
    <div className="grid gap-6">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          <h1 className="text-2xl font-black tracking-tight text-[color:var(--px-text)] sm:text-3xl">{title}</h1>
      ...
      {items.map((item, index) => (
        <Card className="relative overflow-hidden" key={item.label}>
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <span className="ptahx-soft-tile grid h-8 w-8 place-items-center rounded-[var(--px-radius-sm)]">
