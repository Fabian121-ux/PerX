...
export default function PreviewDealWorkspacePage() {
  ...
  return (
    <AppSection description="Preview Mode: Deal state is controlled by simulated deal-state transitions. No real funds are collected or held by PtahX." title={deal.title}>
