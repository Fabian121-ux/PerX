...
export default async function EscrowPage({ params }: { params: Promise<{ dealId: string }> }) {
  ...
  return (
    <AppSection description="Payment and escrow functionality is not active during this beta. No real funds are collected or held by PtahX; this page only shows simulated deal-state records." title="Simulated escrow status">
