  ...
  const normalized =
    "profile" in profile
      ? {
          ...
          name: profile.name,
          roles: profile.roles.map((entry: any) => entry.role.label),
        ...
        <Card>
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div className="flex flex-col items-end gap-3">
              <div className="flex items-center gap-2 rounded-full bg-emerald-50 px-3 py-1 text-sm font-semibold text-emerald-800 ring-1 ring-emerald-200">
                <ShieldCheck size={16} />
                Identity Verified
              </div>
